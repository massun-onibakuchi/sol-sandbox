...
import "../../src/contracts/curta/TinySig.sol";
...
contract TestTinySig is Test {
    ...
    function testInvariant_HuffCallee() public {
        address huffCallee = HuffDeployer.deploy("contracts/curta/TinySigCallee");
    ...
    function testExploit() public {
        address target = HuffDeployer.deploy("contracts/curta/TinySigTargetHuff");
